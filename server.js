...
/** Upsert lock wraps (photo hashes + pin wraps) — server stores only sealed material */
...
/**
 * Upload sealed item (ciphertext only — never plaintext)
 * body: { id, deviceId, deviceName, section, mediaType, filename, mime, byteSize, iv, ciphertext, thumb?, userKey? }
 */
